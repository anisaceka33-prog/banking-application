...
DATABASES = {
    'default': {
        ...
        'USER': config('DB_USER', default='banking_user'),
        'PASSWORD': config('DB_PASSWORD', default='banking_password'),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'A comprehensive banking API with accounts, cards, and transactions',
    'VERSION': '1.0.0',
